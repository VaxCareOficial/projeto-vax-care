...
function listar(idEmpresa) {
    var instrucao =  `
     SELECT u.idUsuario, u.nome, email, e.nome as nomeFilial FROM Usuario as u left join enderecoFilial as e on u.fkEnderecoFilial = e.idEnderecoFilial  where u.fkEmpresa = ${idEmpresa} AND u.tipoUsuario = 'Funcionario' ORDER BY u.idUsuario DESC; 
`;
